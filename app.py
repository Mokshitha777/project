...
with button_col2:
    if st.button("➡ Generate Next Chapter ➡", use_container_width=True, disabled=not st.session_state.generated_story):
...
with button_col3:
    if st.button("✏ Refine Story ✏", use_container_width=True, disabled=not st.session_state.generated_story):
